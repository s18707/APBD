...
{
    public partial class s18707Context : DbContext
    {
        public s18707Context()
        {
        }

        public s18707Context(DbContextOptions<s18707Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s18707;Integrated Security=True");
            }
        }
