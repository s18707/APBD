...
namespace Cw5.Services
{
    public class SqlServerStudentDbService : IStudentDbService
    {
        ...
        public EnrollStudentResult EnrollStudent(EnrollStudentRequest request)
        {
            ...
            using (var con = new SqlConnection("Data Source=db-mssql;Initial Catalog=s18707;Integrated Security=True"))
        ...
        {
            using (var connection = new SqlConnection("Data Source=db-mssql;Initial Catalog=s18707;Integrated Security=True"))
